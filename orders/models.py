...
class OrderInfo(models.Model):
    ...
    # 20220301143930007      #这是主键，注意不用自增id
    ...
    # 运费
    freight = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="运费")  #数中允许的最大数目的数字10，存储的小数位数的位数2

    # 订单状态
    status = models.SmallIntegerField(verbose_name="订单状态", choices=STATUS_CHOICES)

    # 冗余地址字段 #以防止地址表单变更后过去的订单地址也跟着变，所以这里也带地址
